    ...
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <table className="w-[100%] lg:w-[80%] self-center border-separate">
          <thead>
            <tr>
              <th className="border-2 border-blue-200 p-2 bg-blue-200">Módulo a convalidar</th>
              <th className="border-2 border-blue-200 p-2 bg-blue-200">Formación a aportar</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td rowSpan="5" className="border-2 border-blue-200 p-2 text-center bg-blue-200">FOL GM (LOGSE Ley Orgánica 1/1990, de 3 de octubre)</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GM LOGSE</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GS LOGSE</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GM LOE</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GS LOE</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 text-center bg-blue-200">FOL GS (LOGSE Ley Orgánica 1/1990, de 3 de octubre)</td>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GS LOGSE</td>
            </tr>
            <tr>
              <td rowSpan="6" className="border-2 border-blue-200 p-2 text-center bg-blue-200">FOL GM (LOE Ley Orgánica 2/2006, de 3 de mayo)</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GM LOE</td>
            </tr>
            ...
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GM LOGSE + Certificado nivel básico actividad preventiva</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GS LOGSE + Certificado nivel básico actividad preventiva</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">Título Técnico Superior en Prevención de Riesgos Profesionales</td>
            </tr>
            <tr>
              <td rowSpan="6" className="border-2 border-blue-200 p-2 text-center bg-blue-200">FOL GS (LOE Ley Orgánica 2/2006, de 3 de mayo)</td>
            </tr>
            <tr>
              <td className="border-2 border-blue-200 p-2 hover:bg-blue-200">FOL GM LOE</td>
            </tr>
