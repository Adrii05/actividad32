  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <ItemLista>Por un lado, los diferentes <b>Anexos del</b> <Link className='text-blue-600 underline' href="https://www.todofp.es/convalidaciones-equivalencias-homologaciones/convalidaciones/normativa-de-apoyo.html">Real Decreto 1085/2020, de 9 de diciembre, por el que se establecen convalidaciones de módulos profesionales de los títulos de Formación Profesional del sistema educativo español y las medidas para su aplicación, y se modifica el Real Decreto 1147/2011, de 29 de julio, por el que se establece la ordenación general de la formación profesional del sistema educativo.</Link> Aquí puedes consultar las tablas de convalidaciones del Real decreto 1085/2020, de 9 de diciembre (<Link className='text-blue-600 underline' href="https://www.boe.es/buscar/doc.php?id=BOE-A-2020-17274">tablas de convalidación</Link>).</ItemLista>
        ...
        <ItemLista>La convalidación del módulo FOL puedes consultarla en el siguiente enlace: <Link className="text-blue-600 underline" href="https://www.todofp.es/convalidaciones-equivalencias-homologaciones/convalidaciones.html">Convalidación de FOL.</Link></ItemLista>
        <ItemLista>La convalidación del módulo EIE puedes consultarla en el siguiente enlace: <Link className="text-blue-600 underline" href="https://www.todofp.es/convalidaciones-equivalencias-homologaciones/convalidaciones.html">Convalidación de EIE.</Link></ItemLista>
      <Image
