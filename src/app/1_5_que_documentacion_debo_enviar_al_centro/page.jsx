  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <ItemLista><b>Solicitud de convalidación</b> que encuentras en este <Link className="text-blue-600 underline" href="https://www.juntadeandalucia.es/educacion/portals/web/formacion-profesional-andaluza/estudiante/posibilidades-tras-formarme/convalidaciones-modulos">enlace (ver &quot;Impreso solicitud convalidación módulos profesionales&quot;)</Link>. En ese documento es imprescindible que cumplimentes todos los apartados. En este <Link className="text-blue-600 underline" href="https://www.juntadeandalucia.es/educacion/portals/web/formacion-profesional-andaluza/estudiante/posibilidades-tras-formarme/convalidaciones-modulos">enlace</Link> puedes consultar los módulos de cada ciclo impartido con su nombre y el código exacto. Para ello, debes desplegar dentro de cada centro, el apartado &quot;Módulos ofertados de este ciclo&quot;. Recuerda que el plazo para enviar la solicitud de convalidación concluye a finales de octubre.</ItemLista>
        ...
        <p><b>Aunque ya se ha dicho anteriormente, se recuerda que <span className="underline">todos los documentos (excepto el DNI y el documento de la solicitud de convalidación) tienen que ser original o copia compulsada. También se recuerda que el centro no puede tramitar ante el Ministerio de Educación ninguna solicitud que no venga acompañada de la documentación establecida.</span></b></p>
        ...
        <Image className=" self-center border-2 border-black"
